...
from KaizuryuBot import dispatcher, telethn
from KaizuryuBot.__main__ import (
    CHAT_SETTINGS,
    DATA_EXPORT,
    DATA_IMPORT,
    HELPABLE,
...
from KaizuryuBot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module(f"KaizuryuBot.modules.{text}")
    except:
