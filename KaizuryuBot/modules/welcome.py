...
import KaizuryuBot.modules.sql.welcome_sql as sql
import KaizuryuBot
...
from KaizuryuBot.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                creator = None
                if not KaizuryuBot.ALLOW_CHATS:
                    with suppress(BadRequest):
                        update.effective_message.reply_text(
